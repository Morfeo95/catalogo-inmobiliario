...
export default function Footer() {
    return(
        <footer className='w-full'>
            <div className='flex justify-between mt-15 w-11/12 mx-auto
            rounded-2xl p-3'
                style={{
            ...
            >
                <ul className='text-lg'>
                    <li className='text-3xl font-bold'>{data.ciudad}</li>
                    <li>{data.email}</li>
                    <li>{data.telefono}</li>
                    <li>{data.whatsapp}</li>
                ...
                <ul className='flex flex-col justify-end items-center text-md'>
                ...
                <ul className='flex flex-col justify-center'>
                    <li className='text-3xl font-bold'>sigue nuestras redes:</li>
